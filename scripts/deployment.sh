...
MESSAGE="<b>🚀DEPLOYMENT STATUS</b>: $1%0A%0A<b>🔁VERSION</b>: $BUILD_NUMBER%0A%0A<b>👨🏻‍💻COMMITTER</b>: $COMMITTER%0A%0A<b>✍MESSAGE</b>: $COMMIT_MSG%0A%0A<b>📅DATETIME</b>: $DATE $TIME⏰%0A%0A<u>LINK TO SEE COMMIT</u>: https://gitlab.camcyber.com/pos/v1/api/-/commit/$COMMIT_LINK"
